---
name: run-web
description: Build, run, and drive the LumaBrief web app (apps/app, Expo Router). Use when asked to start the app, take a screenshot of it, or verify a UI change actually works in the browser.
---
